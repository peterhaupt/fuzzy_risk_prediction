...
def run_experiment(df, sample_size=None, nr_clus=10, clustering_method='fcm', mf_shape='gauss', consequent_method="local_LSE", merge_threshold=1.0, random_state=81, m=None, covariance_type=None):
    """
    ...
    - m: Fuzziness coefficient for FCM, FST-PSO, GK (optional).
    - covariance_type: Type of covariance to use in GMM (optional).
